                            ...
                            case 1:
                                ...
                                switch (courseType){
                                    ...
                                    case "3":
                                        ...
                                        break;
                                    case "4":
                                        grade1CourseTypeName = '行政班课程';
                                        break;
                                    case "5":
                                        grade1CourseTypeName = '教学班课程';
                                        break;
                                    default:
                                        break;
                                }
                            ...
                            case 2:
                                ...
                                switch (courseType){
                                    ...
                                    case "3":
                                        ...
                                        break;
                                    case "4":
                                        grade2CourseTypeName = '行政班课程';
                                        break;
                                    case "5":
                                        grade2CourseTypeName = '教学班课程';
                                        break;
                                    default:
                                        break;
                                }
                            ...
                            case 3:
                                ...
                                switch (courseType){
                                    ...
                                    case "3":
                                        ...
                                        break;
                                    case "4":
                                        grade3CourseTypeName = '行政班课程';
                                        break;
                                    case "5":
                                        grade3CourseTypeName = '教学班课程';
                                        break;
                                    default:
                                        break;
                                }
    ...
    addCourseLayer: function (title, id, courseName,courseMapList) {
        ...
        switch (grade1CourseType){
            case "0":
                ...
                addCourseContentHtml.push('<span class="course-type-form hides">');
                addCourseContentHtml.push('<label><input name="form-field-checkbox" id="" dataId = "1" type="checkbox" class="ace" /><span class="lbl">文科班开设课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-checkbox" id=""  dataId = "2" type="checkbox" class="ace" /><span class="lbl">理科班开设课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('<span class="class-type-form hides">');
                addCourseContentHtml.push('<label><input name="form-field-radio1" dataId = "4" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio1" dataId = "5" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "1":
                ...
                addCourseContentHtml.push('<span><i>*</i>高一年级课程类型：</span>');
                addCourseContentHtml.push('<span class="course-type-form">');
            ...
            case "4":
                addCourseContentHtml.push('<div class="box-row box-row-course-type box-row-1" grade="高一年级">');
                addCourseContentHtml.push('<span><i>*</i>高一年级课程类型：</span>');
                addCourseContentHtml.push('<span class="class-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-radio1" dataId = "4" checked="checked" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio1" dataId = "5" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "5":
                ...
                addCourseContentHtml.push('<span class="class-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-radio1" dataId = "4" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio1" dataId = "5" checked="checked" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            default:
        ...
        switch (grade2CourseType){
            case "0":
                ...
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('<span class="class-type-form hides">');
                addCourseContentHtml.push('<label><input name="form-field-radio2" dataId = "4" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio2" dataId = "5" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "1":
            ...
            case "4":
                ...
                addCourseContentHtml.push('<span><i>*</i>高二年级课程类型：</span>');
                addCourseContentHtml.push('<span class="class-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-radio2" dataId = "4" checked="checked" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio2" dataId = "5" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "5":
                ...
                addCourseContentHtml.push('<span class="class-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-radio2" dataId = "4" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio2" dataId = "5" checked="checked" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            default:
        ...
        switch (grade3CourseType){
            case "0":
                ...
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('<span class="class-type-form hides">');
                addCourseContentHtml.push('<label><input name="form-field-radio3" dataId = "4" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio3" dataId = "5" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "1":
                ...
                addCourseContentHtml.push('<span><i>*</i>高三年级课程类型：</span>');
                addCourseContentHtml.push('<span class="course-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-checkbox" checked="checked" id="" dataId = "1" type="checkbox" class="ace" /><span class="lbl">文科班开设课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-checkbox" id="" dataId = "2" type="checkbox" class="ace" /><span class="lbl">理科班开设课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "2":
                ...
                addCourseContentHtml.push('<span class="course-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-checkbox" id="" dataId = "1" type="checkbox" class="ace" /><span class="lbl">文科班开设课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-checkbox" checked="checked"  id="" dataId = "2" type="checkbox" class="ace" /><span class="lbl">理科班开设课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "3":
                ...
                break;
            case "4":
                addCourseContentHtml.push('<div class="box-row box-row-course-type  box-row-2 hides" grade="高三年级">');
                addCourseContentHtml.push('<span><i>*</i>高三年级课程类型：</span>');
                addCourseContentHtml.push('<span class="class-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-radio3" dataId = "4" checked="checked" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio3" dataId = "5" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            case "5":
                addCourseContentHtml.push('<div class="box-row box-row-course-type  box-row-2 " grade="高三年级">');
                addCourseContentHtml.push('<span><i>*</i>高三年级课程类型：</span>');
                addCourseContentHtml.push('<span class="class-type-form">');
                addCourseContentHtml.push('<label><input name="form-field-radio3" dataId = "4" type="radio" class="ace" /><span class="lbl">行政班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('<label><input name="form-field-radio3" dataId = "5" checked="checked" type="radio" class="ace" /><span class="lbl">教学班课程</span></label>&nbsp;&nbsp;&nbsp;&nbsp;');
                addCourseContentHtml.push('</span>');
                addCourseContentHtml.push('</div>');
                break;
            default:
            ...
            for (var l = 0; l < dataObj.length; l++) {
                if (dataObj[l].gradeCode == id) { // 判断年级
                    ...
                    if ($(this).is(':checked')) {
                        ...
                        if (classType == 3) {
                            console.log("判断年级文理科="+id);
                            $('.box-row-' + id).removeClass('hides')
                                .find('.course-type-form').removeClass('hides');
                        }else if (classType == 2) {
                            console.log("判断年级行政走读="+id);
                            $('.box-row-' + id).removeClass('hides')
                                .find('.class-type-form').removeClass('hides');
                        }
                    } else {
                        $(this).prop('checked', false);
                        if (classType == 3) {
                            $('.box-row-' + id).addClass('hides').find('.course-type-form').addClass('hides').find('input[type="checkbox"]').prop('checked', false);
                        }else if (classType == 2) {
                            $('.box-row-' + id).addClass('hides').find('.class-type-form').addClass('hides').find('input[type="radio"]').prop('checked', false);
                        }
                    }
                }
            }
        ...
        for(var i=0;i<$('.form-input-checkbox[type="checkbox"]').length;i++){
            ...
            if (_this.is(':checked')) {
                ...
                if ($('.box-row-' + gradeId).is(":visible")) {
                    ...
                    var fsg = $('.box-row-' + gradeId).find('.course-type-form').is(":visible")
                    console.log(fsg)
                    if($('.box-row-' + gradeId +' .course-type-form').is(":visible")){
                    ...
                    }else if($('.box-row-' + gradeId + ' .class-type-form').is(":visible")){
                        if($('.box-row-' + gradeId).find('input[type="radio"]:checked').val()==null){
                            layer.tips('请选择高' + gradeId + '年级课程类型', $('.box-row-' + gradeId));
                            return false;
                        }else{
                            gradeSubType = $('.box-row-' + gradeId).find('input[type="radio"]:checked').attr('dataid');
                        }
                    }
