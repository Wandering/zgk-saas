...
<head>
    ...
    <link rel="stylesheet" href="<%=ctx%>/static/src/css/data-query/professional-info.css?v=20170309"/>
</head>
<body>
...
<script src="<%=ctx%>/static/src/js/data-query/professional-info.js?v=20170309"></script>
